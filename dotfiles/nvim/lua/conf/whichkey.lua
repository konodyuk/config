return function()
	...
	local setup = {
		...
		-- operators = { g = { c = "Comment/Uncomment" }, ["<leader>"] = { r = "Send to REPL" }, ["ys"] = "Add surrounding" },
		-- operators = { ["gc"] = "Comment/Uncomment", ["<leader>r"] = "Send to REPL", ["ys"] = "Add surrounding" },
		-- operators = { d = "Delete", ["gc"] = "Comment", ["ys"] = "Add surrounding" },
		key_labels = {
	...
	local mappings = {
		...
		["E"] = { "<cmd>Neotree reveal<cr>", "Reveal current file" },
		["w"] = { "<cmd>w!<CR>", "Save" },
